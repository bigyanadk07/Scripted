...
import Logo from '../../../Images/ScriptedWhite.png'
  ...
  <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
    <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
      ...
      <img src={Logo} alt=""  className='w-32 h-auto'/>
        ...
        <p className="mt-4 leading-relaxed text-white/90">
          Scripted is a custom made, personal blogging web platform.
        </p>
      </div>
    </section>
    ...
    >
      <div className="max-w-xl lg:max-w-3xl">
        ...
        <h1 className="text-3xl font-bold sm:text-4xl text-center">User SignUp</h1>
        <form action="#" className="mt-8 grid grid-cols-6 gap-6">
          ...
          <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
            ...
            <p className="mt-4 text-sm text-gray-500 sm:mt-0">
              ...
              <Link to="/sign-in" className="text-gray-700 underline">Log in</Link>.
            </p>
          </div>
        </form>
      </div>
